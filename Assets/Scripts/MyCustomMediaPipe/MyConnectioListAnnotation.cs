...
public sealed class MyConnectionListAnnotation : ListAnnotation<ConnectionAnnotation>
{
    ...
    public void Fill(IList<(int, int)> connections, MyPointListAnnotation points)
    {
